# 
# modify version of adafruit_veml6070 to support in micropython for ESP8266
# 
# Fork from  https://github.com/adafruit/Adafruit_VEML6070
...
"""
`veml6070_i2c` - VEML6070 UV Sensor
====================================================
...
class VEML6070:
    ...
    def __init__(self,i2c_cmd: int = _VEML6070_ADDR_CMD,i2c_low: int=_VEML6070_ADDR_LOW ,i2c_high: int= _VEML6070_ADDR_HIGH, _veml6070_it="VEML6070_1_T",i2c=None, ack=False):
        ...
        self.i2c.writeto(self.i2c_cmd, self.buf)
    ...
    def uv_raw(self):
        ...
        bufferL = bytearray(1)
        bufferH = bytearray(1)
        self.i2c.readfrom_into( self.i2c_low ,bufferL)
        self.i2c.readfrom_into( self.i2c_high ,bufferH)
           
        return bufferH[0] << 8 | bufferL[0]
    ...
    def sleep(self):
        ...
        with self.i2c_cmd as i2c_cmd:
            self.i2c.writeto(i2c_cmd, self.buf, start=0, end=len(self.buf))
